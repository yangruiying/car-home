package com.platform.idleplatform.Imp;
 ...
 * 所以可以用一个静态set保存起来。
 */
@ServerEndpoint(value = "/websocket/{nickname}/{goodsId}")
@Component
public class MyWebSocket {
    ...
    @OnOpen
    public void onOpen(Session session, @PathParam("nickname") String nickname, @PathParam("goodsId") String goodsId) {
     ...
     */
    @OnMessage
    public void onMessage(String message, Session session, @PathParam("nickname") String nickname, @PathParam("goodsId") String goodsId) throws Exception {
